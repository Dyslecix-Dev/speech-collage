...
const Card = ({ imgSrc, title, description }: { imgSrc: string; title: string; description: string }) => {
  return (
    <motion.div whileHover="hover" className="w-full h-[300px] relative">
      ...
      />
      <a href="#" rel="nofollow" className="w-1/2 h-1/2 absolute bottom-0 right-0 z-0 grid place-content-center bg-white text-black hover:text-indigo-500 transition-colors">
